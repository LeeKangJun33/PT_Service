...
import com.example.pt_service.job.pass.AddPassesTasklet;
import com.example.pt_service.repository.pass.*;
import com.example.pt_service.repository.user.UserGroupMappingEntity;
import com.example.pt_service.repository.user.UserGroupMappingRepository;
...
public class AddPassesTaskletTest {
    ...
    @InjectMocks
    private AddPassesTasklet addPassesTasklet; // @InjectMocks 클래스의 인스턴스를 생성하고 @Mock 으로 생성된 객체를 주입
